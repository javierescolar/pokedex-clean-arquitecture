...
describe('MapperPokeapiService', () => {
  const pokemonPokeApiExample: PokemonPokeApiDto = {
    abilities: [
      {
        ability: {
          name: 'static',
  ...
  let service: MapperPokeapiService;

  beforeEach(() => {
    TestBed.configureTestingModule({});
    service = TestBed.inject(MapperPokeapiService);
  });
  ...
  it('mapFrom(input: PokemonPokeApiDto) should returned instance of Pokemon', () => {
